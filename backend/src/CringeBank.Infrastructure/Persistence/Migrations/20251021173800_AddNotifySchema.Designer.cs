...
namespace CringeBank.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251021173800_AddNotifySchema")]
    partial class AddNotifySchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CringeBank.Domain.Notify.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CringeBank.Domain.Notify.Entities.NotificationOutboxMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CringeBank.Domain.Notify.Entities.Notification", b =>
                {
                    b.HasOne("CringeBank.Domain.Auth.Entities.AuthUser", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("CringeBank.Domain.Notify.Entities.NotificationOutboxMessage", b =>
                {
                    b.HasOne("CringeBank.Domain.Notify.Entities.Notification", "Notification")
